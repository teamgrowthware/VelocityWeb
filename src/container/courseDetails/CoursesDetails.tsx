              ...
              <table className="table table-hover mb-0 modern-table">
                <thead>
                  <tr
                    style={{
                      background:
                        "linear-gradient(to right, #f8f9ff 0%, #e6e9ff 100%)",
                    }}
                  >
                    <th
            ...
            <div className="row">
              <div className="col-md-8">
                <div className="innerBox">
                  <h2>
                    {!pageContentLoading && "loading..."} {pageContent?.name}
                  </h2>
                  <div
                    className="ql-editor"
                  ...
                  <div className="container my-4">
                    <ul
                      className="nav nav-pills custom-tabs d-flex gap-2 p-2"
                      style={{
                        background:
                    ...
                    >
                      {accordienContent?.map((item, index) => {
                        ...
                        return (
                          ...
                          >
                            <button
                              className={`btn w-100 fw-semibold py-3 px-4 tab-button ${
                                isActive ? "active" : ""
                              }`}
                              style={{
                                background: isActive
                    ...
                    <div className="infoBoxCourse">
                      <ul className="list-unstyled m-0">
                        <li
                          ...
                          style={{
                            background:
                              "linear-gradient(to right, #f8f9ff 0%, #ffffff 100%)",
                          }}
                        >
                          <div className="d-flex align-items-center justify-content-between">
                            <div className="d-flex align-items-center gap-2">
                              <span
                                className="material-symbols-outlined text-white bg-primary rounded-circle p-2 d-flex align-items-center justify-content-center"
                                style={{
                                  width: "40px",
                                  height: "40px",
                                  fontSize: "20px",
                            ...
                            <p className="mb-0 fw-bold text-primary mx-2 fs-5">
                              ₹{pageContent?.fees}
                            </p>
                          </div>
                        </li>
                        ...
                        >
                          <div className="d-flex align-items-center justify-content-between">
                            <div className="d-flex align-items-center gap-2">
                              <span
                                className="material-symbols-outlined text-white rounded-circle p-2 d-flex align-items-center justify-content-center"
                                style={{
                                  width: "40px",
                                  height: "40px",
                                  fontSize: "20px",
                        ...
                        >
                          <div className="d-flex align-items-center justify-content-between ">
                            <div className="d-flex align-items-center gap-2">
                              <span
                                className="material-symbols-outlined text-white bg-info rounded-circle p-2 d-flex align-items-center justify-content-center"
                                style={{
                                  width: "40px",
                                  height: "40px",
                                  fontSize: "20px",
                            ...
                            <p className="mb-0 fw-bold text-info mx-2 ">
