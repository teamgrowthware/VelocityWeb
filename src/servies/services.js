...
export const getCourses = async (id, useCache) => {
  ...
  const response = await API.get(
    process.env.react_app_base_url +
      "/api/v1/cources?status=0&sortBy=order_id=-1",
    {
      headers: {
        "auth-token": `${token}`,
      },
...
export const getCenterBatchByCourseId = async (id, useCache) => {
  ...
  const response = await API.get(
    process.env.react_app_base_url +
      `/api/v1/centerbatch/byCourseId/${id}?status=0`,
    {
      headers: {
        "auth-token": `${token}`,
      },
...
export const getModuleByCourseId = async (id, useCache) => {
  console.log("service FieldById", id);
  const response = await API.get(
    process.env.react_app_base_url + `/api/v1/modules/moduleByCourse/${id}`,
    {
      headers: {
        "auth-token": `${token}`,
      },
...
export const getTestimonialsByCourseId = async (id, useCache) => {
  // console.log("service FieldById", id)
  const response = await API.get(
    process.env.react_app_base_url + `/api/v1/cms/cms/bytype/${id}?status=0`,
    {
      headers: {
        "auth-token": `${token}`,
      },
...
export const getCategoryforCMSType = async (id, useCache) => {
  ...
  const response = await API.get(
    process.env.react_app_base_url +
      `/api/v1/cms/cms_categories_by_cms_type/${id}?status=0`,
    {
      headers: {
        "auth-token": `${token}`,
      },
...
export const getCMS = async (id, useCache) => {
  // console.log("service FieldById", id)
  const response = await API.get(
    process.env.react_app_base_url + "/api/v1/cms/pages",
    {
      headers: {
        "auth-token": `${token}`,
      },
...
export const getCenters = async (id, useCache) => {
  console.log("service FieldById", id);
  const response = await API.get(
    process.env.react_app_base_url + "/api/v1/centerbatch?status=0",
    {
      headers: {
        "auth-token": `${token}`,
      },
...
export const getSliders = async () => {
  const response = await API.get(
    process.env.react_app_base_url +
      "/api/v1/cms/cms/bytype/Slider?sortBy=order_id",
    {
      headers: {
        "auth-token": `${token}`,
      },
...
export const getCourseSlug = async (id, useCache) => {
  ...
  const response = await API.get(
    process.env.react_app_base_url + `/api/v1/cources/course-slug/${id}`,
    {
      headers: {
        "auth-token": `${token}`,
      },
...
export const EnquiryDetails = async (data, useCache) => {
  ...
  const response = await API.post(
    process.env.react_app_base_url + "/api/v1/enquiry",
    data,
    {
      headers: {
        "auth-token": `${token}`,
...
export const checkEnquiryStatus = async (courseId, email, phone) => {
  console.log("checkEnquiryStatus", courseId, email, phone);
  const response = await API.get(
    process.env.react_app_base_url + "/api/v1/enquiry/check-status",
    {
      params: {
        courseId: courseId,
        email: email,
...
export const EnquiryFrontendDetails = async (data, useCache) => {
  console.log("service CustomTypeById", data);
  const response = await API.post(
    process.env.react_app_base_url + "/api/v1/frontend/subscribe",
    data,
    {
      headers: {
        "auth-token": `${token}`,
...
export const getWhyUs = async () => {
  const response = await API.get(
    process.env.react_app_base_url +
      `/api/v1/cms/cms/bytype/Why%20Velocity?sortBy=order_id&status=0`,
    {
      headers: {
        "auth-token": `${token}`,
      },
...
export const getClients = async () => {
  const response = await API.get(
    process.env.react_app_base_url +
      `/api/v1/cms/cms/bytype/clients?sortBy=order_id&status=0`,
    {
      headers: {
        "auth-token": `${token}`,
      },
...
export const getBlog = async (id, useCache) => {
  ...
  const response = await API.get(
    process.env.react_app_base_url +
      "/api/v1/cms/cms/bytype/Blog?sortBy=order_id",
    {
      headers: {
        "auth-token": `${token}`,
      },
...
export const getBlogDetails = async (slug, useCache) => {
  ...
  const response = await API.get(
    process.env.react_app_base_url + `/api/v1/cms/cms-slug/${slug}`,
    {
      headers: {
        "auth-token": `${token}`,
      },
